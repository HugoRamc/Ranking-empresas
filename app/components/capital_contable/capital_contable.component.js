...
var CapitalContable = (function () {
    function CapitalContable(_companyService) {
        this._companyService = _companyService;
    }
    CapitalContable.prototype.ngOnInit = function () {
        var _this = this;
        this.getCompanies();
        setTimeout(function () {
            _this.getDomData();
    ...
    CapitalContable.prototype.getDomData = function () {
    ...
    CapitalContable.prototype.getCompanies = function () {
        var _this = this;
        this._companyService.getCompanies()
            .subscribe(function (companies) { return _this.companies = companies; }, function (error) { return _this.errorString = error; });
    };
    CapitalContable = __decorate([
        core_1.Component({
            templateUrl: './app/templates/pasivos/capital-contable.html',
...
exports.CapitalContable = CapitalContable;
//# sourceMappingURL=capital_contable.component.js.map