...
var ActivoFijo = (function () {
    function ActivoFijo(_companyService) {
        this._companyService = _companyService;
    }
    ActivoFijo.prototype.ngOnInit = function () {
        var _this = this;
        this.getCompanies();
        setTimeout(function () {
            _this.getDomData();
    ...
    ActivoFijo.prototype.getDomData = function () {
    ...
    ActivoFijo.prototype.getCompanies = function () {
        var _this = this;
        this._companyService.getCompanies()
            .subscribe(function (companies) { return _this.companies = companies; }, function (error) { return _this.errorString = error; });
    };
    ActivoFijo = __decorate([
        core_1.Component({
            templateUrl: './app/templates/activos/activo-fijo.html',
...
exports.ActivoFijo = ActivoFijo;
//# sourceMappingURL=activo_fijo.component.js.map