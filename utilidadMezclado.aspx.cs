...
public partial class utilidadMezclado : System.Web.UI.Page
{
    private Double PE;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (!IsPostBack)
            {
                porcentajes porcen = new porcentajes(Session["empresa"].ToString(),false);
                ...
                if (porcen.checarPorcentajes())
                {
                    ...
                    lblutilidadEsperada.Text = "El porcentaje de la utilidad esperada es: " + porcen.getPorcentajeUtilidad() + "%";
                    ; ;
